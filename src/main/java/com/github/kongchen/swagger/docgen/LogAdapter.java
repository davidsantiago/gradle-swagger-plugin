...
//import sun.util.logging.resources.logging.Log;
...
public class LogAdapter {
    ...
    /*
     * public LogAdapter(Log log) { this.logger = log; }
     */
    ...
    private void invoke(String methodName, String s) {
        try {
            ...
            if (logger instanceof Logger) {
               ...
               * else if (logger instanceof Log) { m = logger.getClass().getDeclaredMethod(methodName,
               * CharSequence.class); }
               */
            if (m != null) {
                m.invoke(logger, s);
