        ...
        if (responseClass != null && !responseClass.equals(Void.class) && !responseClass.equals(ResponseEntity.class)
            ...
            if (isPrimitive(responseClass)) {
                ...
                if (property != null) {
                    ...
                    operation.response(200, new Response().description("successful operation").schema(responseProperty)
                ...
                if (models.size() == 0) {
                    ...
                    operation.response(
                            200,
                            new Response().description("successful operation").schema(pp)
                                    .headers(defaultResponseHeaders));
                }
            ...
            for (Method method : methods) {
                ...
                if (methodRequestMapping instanceof RequestMapping) {
                    ...
                    for (RequestMethod requestMappingRequestMethod : requestMappingRequestMethods) {
                        ...
                        // Check for cases where method-level @RequestMapping#value is not set, and use the controllers
                        // @RequestMapping
                        if (methodRequestMappingValues == null || methodRequestMappingValues.length == 0) {
                            ...
                            for (String methodRequestMappingValue : methodRequestMappingValues) {
                                ...
                                if (!(resourceName.equals(""))) {
                                    if ((!(resourceMap.containsKey(resourceKey)))) {
                                        resourceMap.put(resourceKey, new SpringResource(clazz, resourceName,
